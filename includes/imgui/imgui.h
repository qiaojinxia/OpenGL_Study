...
namespace ImGui
{
    ...
    IMGUI_API void          ShowStyleEdiImGui_ImplOpenGL3_CreateFontsTexturetor(ImGuiStyle* ref = NULL);    // add style editor block (not a window). you can pass in a reference ImGuiStyle structure to compare to, revert to and save to (else it uses the default style)
